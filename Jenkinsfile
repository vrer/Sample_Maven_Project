pipeline {
    ...
    tools {
        ...
        stage ('nexus uploader') {
            steps {
                nexusPublisher nexusInstanceId: 'nexus', nexusRepositoryId: 'nexus_relese', packages: [[$class: 'MavenPackage', mavenAssetList: [], mavenCoordinate: [artifactId: 'simple-web-app', groupId: 'org.mitre', packaging: 'war', version: '5.3']]]
            }
        }
    }
    post {
